...
#+begin_src emacs-lisp
  (setq
   user-cache-directory (expand-file-name "cache" user-emacs-directory)
   no-littering-etc-directory (expand-file-name "config/" user-cache-directory)
   no-littering-var-directory (expand-file-name "data/" user-cache-directory))
...
*** Childframe Support for Completion at Point
